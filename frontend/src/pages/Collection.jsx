...
const Collection = () => {
  ...
  // Filtering Functions & Logics
  const toogleCategory = (event) => {
  ...
  const sortProduct = () => {
    ...
    switch (sortType) {
      case "low-high":
        setFilterProducts(
          filterProductsCopy.sort(
            (item_1, item_2) => item_1.price - item_2.price
          )
        );
        break;
      case "high-low":
